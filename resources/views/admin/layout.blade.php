...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>暴漫</b>漫</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>暴走</b>漫画</span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-user text-red"></i> 更改用户名
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="#" class="btn btn-default btn-flat">退出登录s</a>
                                </div>
                            </li>
                        </ul>
                    </li>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ asset('admin/user/index') }}"><i class="fa fa-th-list"></i> 用户列表 </a></li>
                        <li><a href="{{ asset('admin/index/insert') }}"><i class="fa fa-circle-o"></i> 增加用户</a></li>
